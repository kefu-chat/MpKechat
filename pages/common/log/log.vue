        ...
        >
          <template v-slot:node>
            <view class="tui-node">
              <tui-icon
                name="explore-fill"
                :color="version == item.version ? '#5c8dff' : '#ddd'"
                :size="18"
              />
            </view>
          </template>
          <template v-slot:content>
            <view
              class="tui-content-log"
              :class="[version == item.version ? '' : 'tui-log-gray']"
            >
              ...
              >
                ...
                <view
                  class="tui-link"
                  @tap.stop="getLink('https://thorui.cn/doc/')"
                >
                  https://thorui.cn/doc/
                </view>
                <view
                  class="tui-link"
                  @tap.stop="getLink('http://www.donarui.com')"
                >
                ...
                <view
                  class="tui-link"
                  @tap.stop="getLink('https://ext.dcloud.net.cn/plugin?id=556')"
                >
                ...
                <view
                  class="tui-link"
                  @tap.stop="getLink('https://github.com/dingyong0214/ThorUI')"
                >
                ...
                <view
                  class="tui-link"
                  @tap.stop="getLink('https://ext.dcloud.net.cn/plugin?id=569')"
                >

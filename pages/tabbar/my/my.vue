<template>
  <view class="container">
    <view class="top-container">
      <image
        class="bg-img"
        src="/static/images/my/mine_bg_3x.png"
      />
      <view
        class="logout"
        hover-class="opcity"
      ...
      >
        <image
          v-show="isLogin"
          class="logout-img"
          src="/static/images/my/icon_out_3x.png"
        />
        <text
          v-show="isLogin"
          class="logout-txt"
    ...
    <view class="middle-container">
      ...
      >
        <image
          class="ticket-img"
          src="/static/images/my/icon_thorui_3x.png"
        />
        <text class="middle-tag">
          Thor UI
        </text>
      </view>
      <view
      ...
      >
        <image
          class="car-img"
          src="/static/images/my/github_3x.png"
        />
        <text class="middle-tag">
          GitHub
        </text>
    ...
    <view class="bottom-container">
      <view class="ul-item">
        ...
        >
          <image
            class="item-img"
            src="/static/images/my/mine_icon_jiayouzhan_3x.png"
          />
        ...
        >
          <image
            class="item-img"
            src="/static/images/my/mine_icon_tingche_3x.png"
          />
          <text class="item-name">
            停车场
          </text>
        ...
        >
          <image
            class="item-img"
            src="/static/images/my/mine_icon_chongdian_3x.png"
          />
          <text class="item-name">
            充电桩
          </text>
      ...
      <view class="ul-item">
        ...
        >
          <image
            class="item-img"
            src="/static/images/my/reward.png"
          />
          <text class="item-name">
            赞赏
          </text>
        ...
        >
          ...
          <image
            class="item-img"
            src="/static/images/my/feedback.png"
          />
          <text class="item-name">
            反馈
          </text>
